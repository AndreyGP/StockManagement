...
class RDefault implements Logger
{
	...
	public function setMode( $mode )
	{
		if ($mode !== self::C_LOGGER_ARRAY && $mode !== self::C_LOGGER_ECHO ) {
			throw new RedException( 'Invalid mode selecte<?php
...
abstract class AQueryWriter
{
	 ...
	 */
	public function queryRecordCount( $type, $conditions = array(), $addSql = NULL, $bindings = array() )<?php
...
class Facade
{
	...
	*/
	 ...
	 *
	 * @param string|array $tables the set of tables names to load at once
	 * @param mixed        $id    the common ID
	 *
	 * @return OODBBean
	 */
	public static function loadMulti( $tables, $id )
	{
		return MultiLoader::load( self::$redbean, $tables, $id );
	}
	 ...
	 * the specified type will be generated and returned.
	 *
	 * @param string  $table type of bean you want to load
	 * @param integer $id   ID of the bean you want to load
	 *
	 * @return OODBBean
	 */
	...
	{
		return self::$redbean->load( $table, $id );
	}
	 ...
	 * or the slot-notation (:keyname).
	 *
	 * @param string $table     the type of bean you are looking for
	 * @param string $sql      SQL query to find the desired bean, starting right after WHERE clause
	 * @param array  $bindings array of values to be bound to parameters in query
	 *
	 * @return array
	 */
	public static function find( $table, $sql = NULL, $bindings = array() )
	{
		return self::$finder->find( $table, $sql, $bindings );
	}
	 ...
	 * @return array
	 */
	public static function findAll( $table, $sql = NULL, $bindings = array() )
	{
		return self::$finder->find( $table, $sql, $bindings );
	}
	 ...
	 * @return OODBBean
	 */
	public static function findOne( $table, $sql = NULL, $bindings = array() )
	{
		return self::$finder->findOne( $table, $sql, $bindings );
	}
	 ...
	 * loadAll.
	 *
	 * @param string $table table name of beans
	 * @param array  $ids  ids to load
	 *
	 * @return array
	 */
	...
	{
		return self::$redbean->batch( $table, $ids );
	}
	 ...
	 *
	 * @param string $tableName name of table you want to destroy entirely
	 *
	 * @return boolean
	 */
	public static function wipe( $tableName )
	{
		return Facade::$redbean->wipe( $tableName );
	}
...
if (!class_exists('Dbmaster')) {
	class Dbmaster extends \RedBeanPHP\Facade{};
}
...
if ( !function_exists( 'dmp' ) ) {
	...
	function dmp( $list )
	{
		echo '<pre>' . print_r( \RedBeanPHP\Facade::dump( $list ), true ) . '</pre>';
	}
}
